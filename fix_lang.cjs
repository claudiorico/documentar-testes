...
const typesPath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'types', 'index.ts');
...
const storePath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'store', 'useTestStore.ts');
...
const dashPath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'components', 'Dashboard.tsx');
...
const runnerPath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'components', 'TestCaseRunner.tsx');
...
const cssPath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'index.css');
...
const excelPath = path.join('c:/Users/User/Projetos/Documentar Testes/src', 'utils', 'excelGenerator.ts');
